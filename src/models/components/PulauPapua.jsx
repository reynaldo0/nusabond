...
export const Pulaupapua = forwardRef(({ onClick, ...props }, ref) => {
  const { nodes, materials } = useGLTF("/models/papua.glb");
      ...
      <group scale={0.01}>
        <group scale={5.6}>
          ...
          <mesh
            ...
            material={materials.tripo_mat_f9581805}
          />
          <mesh
            castShadow
            receiveShadow
...
useGLTF.preload("/models/papua.glb");
